...
//        //this.accordion.openNextSection(true);
    ...
    back: function(){
        ...
        while ((sectionElement === null && stepIndex > 0) || !sectionElement.hasClassName('allow')) {
            --stepIndex;
    ...
    setStepResponse: function(response){
		...
		if (response.grand_pickup_total){
			$('payment-step-total').update(response.grand_pickup_total);
		}
...
ShippingMethod.prototype = {
    ...
    nextStep: function(transport){
        ...
        if (response.update_section) {
            $('checkout-'+response.update_section.name+'-load').update(response.update_section.html);
			$('payment-step-total').update(response.grand_total);
		}
