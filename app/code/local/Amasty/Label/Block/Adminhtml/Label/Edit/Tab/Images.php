...
class Amasty_Label_Block_Adminhtml_Label_Edit_Tab_Images extends Mage_Adminhtml_Block_Widget_Form
{
    protected function _prepareForm()
    {
        ...
        $fldProduct->addField('prod_image_width', 'text', array(
            'label'     => $hlp->__('Label Width'),
            'name'      => 'prod_image_width',
            'note'      => $hlp->__('Percent of the product image; This property is applicable only for automatic label adding'),
        ));

        $fldProduct->addField('prod_image_height', 'text', array(
            'label'     => $hlp->__('Label Height'),
        ...
        $fldCat->addField('cat_image_height', 'text', array(
            'label'     => $hlp->__('Label Height'),
