...
class Sns_Ajaxfilter_CatalogSearch_ResultController extends Mage_CatalogSearch_ResultController
{
	...
	public function indexAction()
	{
		...
		if($this->getRequest()->isXmlHttpRequest()){ 
			...
			$viewpanel = $this->getLayout()->getBlock('mana.catalogsearch.leftnav')->toHtml(); //Get the new Layered Manu
