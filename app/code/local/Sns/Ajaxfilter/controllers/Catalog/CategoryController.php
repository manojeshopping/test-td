...
class Sns_Ajaxfilter_Catalog_CategoryController extends Mage_Catalog_CategoryController
{
	...
	public function viewAction()
	{
		if($this->getRequest()->isXmlHttpRequest()){ //Check if it was an AJAX request
			...
			$viewpanel = $this->getLayout()->getBlock('mana.catalog.leftnav')->toHtml(); // Generate New Layered Navigation Menu
