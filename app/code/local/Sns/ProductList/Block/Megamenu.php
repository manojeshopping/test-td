...
class Sns_ProductList_Block_Megamenu extends Mage_Catalog_Block_Product_List
{
	protected $defaultTemplate = 'sns/productlist/for-menu.phtml';
	...
	protected function _getConfiguration($path = 'productlist_cfg'){
