...
class Sns_Slider_Block_List extends Mage_Catalog_Block_Product_List
{
	protected $defaultTemplate = 'sns/slider/default.phtml';
	...
	protected function _getConfiguration($path = 'slider_cfg'){
