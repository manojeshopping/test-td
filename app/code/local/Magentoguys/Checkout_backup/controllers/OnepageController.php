...
class Magentoguys_Checkout_OnepageController extends Mage_Checkout_OnepageController
{
   ...
   /**
    ...
    {
		$selectedDelivery = $this->getRequest()->getPost('delivery_selected');
		// echo $selectedDelivery;
		// die('exit');
