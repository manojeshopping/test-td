 ...
 */
class Magentoguys_Checkoutc_Model_Sales_Order extends Mage_Sales_Model_Abstract
{
    ...
    public function sendNewOrderEmail()
    {
        ...
        $pickupEnable = Mage::getSingleton('core/session')->getPickupenable();
		
        // Retrieve corresponding email template id and customer name
        if ($this->getCustomerIsGuest() && $pickupEnable!=2) {
            $templateId = Mage::getStoreConfig(self::XML_PATH_EMAIL_GUEST_TEMPLATE, $storeId);
            $customerName = $this->getBillingAddress()->getName();
        } elseif(!$this->getCustomerIsGuest() && $pickupEnable!=2) {
