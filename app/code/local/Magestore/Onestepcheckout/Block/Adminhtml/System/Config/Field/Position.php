        ...
        $html .='
				...
				<script type="text/javascript">
					...
					function checkValueRequire(){
                                                //Start: Huy - Config default state/region = null
                                                if ($("onestepcheckout_general_region_id")){
                                                    $("onestepcheckout_general_region_id").removeClassName("required-entry");}
                                                //End: Huy - Config default state/region = null
