...
class Magestore_Onestepcheckout_Block_Adminhtml_Config_Edit extends Mage_Adminhtml_Block_System_Config_Edit
{
    protected function _prepareLayout()
    {
		parent::_prepareLayout();
                /*Huy - Sua condition de override khi save config: $this->getRequest()->getModuleName()*/
		if($this->getRequest()->getModuleName() && $this->getRequest()->getControllerName() == 'system_config'
