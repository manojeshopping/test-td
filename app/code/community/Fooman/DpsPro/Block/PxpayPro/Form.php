...
class Fooman_DpsPro_Block_PxpayPro_Form extends MageBase_DpsPaymentExpress_Block_Pxpost_Form
{
    protected function _construct()
    {
        parent::_construct();
        $this->setTemplate('fooman/dpspro/pxpaypro/form.phtml');
    }
    ...
    public function displayAddCcSave()
    {
        ...
        && Mage::helper('foomandpspro')->shouldOfferRebillForPxPay();
    }
}
