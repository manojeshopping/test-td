 ...
 */
class Fooman_DpsPro_Block_Webservice_Form extends Fooman_DpsPro_Block_PxpostPro_Form
{
    protected function _construct()
    {
        parent::_construct();
        $this->setTemplate('fooman/dpspro/webservice/form.phtml');
    }
    ...
    public function displayAddCcSave()
    {
        ...
        && Mage::helper('foomandpspro')->shouldOfferRebillForWebservice();
    }
}
